...
import { addGrandTest, getPrelims } from "../services/authService";

const GrandTestsForm = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await addGrandTest(payload);

      Swal.fire({
        toast: true,
        position: "top-end",
        icon: "success",
        title: response.message || "Grand test added successfully",
