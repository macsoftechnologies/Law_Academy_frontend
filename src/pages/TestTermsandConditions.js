...
import TestTermsandConditionsForm from "../forms/TestTermsandConditionsForm";
    ...
    <div>
      <div className="d-flex justify-content-between mb-3">
        ...
        <div className="d-flex gap-2 align-items-center">
          ...
          <Button text="+ Add Test Term" className="secondary" onClick={() => setOpen(true)} />
        </div>
      </div>
