...
export const addMainsTestSeries = async (formData) => {
  const res = await api.post("/mains/addmainstest", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return res.data;
};

export const getMainsTestSeries = async (page = 1, limit = 10, mains_id = "") => {
  const res = await api.get(
    `/mains/mainstests?page=${page}&limit=${limit}${mains_id ? `&mains_id=`: ""}`
  );
  return res.data;
};

export const getMainsTestSeriesById = async (mains_test_id) => {
...
export const updateMainsTestSeries = async (formData) => {
  const res = await api.post("/mains/updatemainstest", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return res.data;
};

export const deleteMainsTestSeries = async (data) => {
  const res = await api.post("/mains/deletemainstest", data);
  return res.data;
};

export const addMainsSubjectTests = async (data) => {
  const res = await api.post("/mains/addmainssubjecttest", data, {
    headers: { "Content-Type": "application/json" },
  });
  return res.data;
};

export const getMainsSubjectTests = async (page = 1, limit = 10, mains_test_id = "") => {
  const res = await api.get(
    `/mains/mainssubjecttests?page=${page}&limit=${limit}${mains_test_id ? `&mains_test_id=` : ""}`
  );
  return res.data;
};

export const getMainsSubjectTestsById = async (mains_subject_test_id) => {
  const res = await api.post("/mains/mainssubjecttestdetails", { mains_subject_test_id }, {
    headers: { "Content-Type": "application/json" },
  });
  return res.data;
};

export const updateMainsSubjectTests = async (data) => {
  const res = await api.post("/mains/updatemainssubjecttest", data, {
    headers: { "Content-Type": "application/json" },
  });
  return res.data;
};

export const deleteMainsSubjectTests = async (data) => {
  const res = await api.post("/mains/deletemainssubjecttest", data);
  return res.data;
};

export const getMainsTestsAttempts = async (page = 1, limit = 10) => {
  const res = await api.get(`/mains/mains_attempts?page=${page}&limit=${limit}`);
  return res.data;
};

export const getMainsTestsAttemptsById = async (mains_attempt_id) => {
...
export const addQA = async (formData) => {
  const res = await api.post("/qa/add", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return res.data;
};

export const getQAByModuleId = async (page = 1, limit = 10) => {
  const res = await api.post(
...
export const getQAById = async (qa_id) => {
...
export const updateQA = async (formData) => {
  const res = await api.post("/qa/update", formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return res.data;
};

export const deleteQA = async (data) => {
  const res = await api.post("/qa/delete", data, {
    headers: { "Content-Type": "application/json" },
  });
  return res.data;
};

export const addMainsResults = async (data) => {
  const res = await api.post("/mains/addresult", data, {
    headers: { "Content-Type": "application/json" },
  });
  return res.data;
};
